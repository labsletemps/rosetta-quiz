...
(function($) {
    ...
    function make_default_how_you_did_html(nCorrect, nQuestions) {
        ...
        return '<span style="margin-left:5%;color:#fff;background-color:#940026;padding:5px 10px 5px 10px;font-family:Georgia;font-size:24px;position:relative;text-transform:uppercase;"><i class="fa fa-chevron-circle-right"></i> VOTRE SCORE</span><br><br><div style="margin-left:5%;"><Vous avez trouv&eacute; <span class="correct_answers"><b><big><big>' + nCorrect + '</b></big></big></span>' +
               answersWord + ' sur <b><big><big>' + nQuestions + '</b></big></big> questions<br><br><br><span><small><hr style="border-bottom:1px solid #666;width:65%;margin-left:0%;"><br>Quiz : Fabien Goubet<br>Crédit photo : ESA</br>Réalisation : Jean Abbiateci<br>Code : <a href="" target="_blank">Newsquiz / Mother Jones</a><br><br></p></span></div> ';
    }
